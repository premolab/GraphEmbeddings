...
from codes.models import BigClam
from .BaseTransformer import BaseTransformer


class BigClamTransformer(BaseTransformer):
    def __init__(self, nx_G, name, d, seed=None, load_dumped_model=True, dump_model=True):
        ...
        self.model = BigClam(np.array(nx.to_numpy_matrix(nx_G)), d, initF='rand', processesNo=1)

    def get_dump_model_filename(self):
        return './dumps/models/bigclam2v_{}_d{}.dump'.format(self.name, self.d)
