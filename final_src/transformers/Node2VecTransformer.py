...
class Node2VecTransformer(BaseTransformer):
    def __init__(self, nx_G, name, d, p=1, q=1, seed=None,
                 load_dumped_model=True, dump_model=True, path_to_dumps=None):
    ...
    def get_dump_model_filename(self):
        return '{}/node2vec_{}_d{}.csv'.format(
            self.path_to_dumps, self.name, self.d
        )
