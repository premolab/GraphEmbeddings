...
from settings import PATH_TO_FOOTBALL, PATH_TO_POLBOOKS
...
def run_polbooks(run_configuration: RunConfiguration, path_to_dumps, seed=43):

    assert run_configuration.graph_name == 'polbooks'
